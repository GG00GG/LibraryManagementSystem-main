...
public class dashboardController implements Initializable {
    ...
    private String comboBox[] = {"Мужской", "Женский", "Другие"};
    ...
    public void takeBook() {
        ...
        try {
            ...
            if (take_FirstName.getText().isEmpty()
                ...
                alert.setTitle("Сообщение администратора");
                alert.setHeaderText(null);
                alert.setContentText("Пожалуйста, введите полную информацию о студенте");
                alert.showAndWait();
            } else if (take_titleLabel.getText().isEmpty()) {
                alert = new Alert(AlertType.ERROR);
                alert.setTitle("Сообщение администратора");
                alert.setHeaderText(null);
                alert.setContentText("Укажите, пожалуйста, книгу, которую вы хотите взять.");
                alert.showAndWait();
            } else {
                ...
                alert.setTitle("Сообщение администратора");
                alert.setHeaderText(null);
                alert.setContentText("Успешно! Беру книгу!");
                alert.showAndWait();
    ...
    public void findBook(ActionEvent event) {
        ...
        try {
            ...
            if (take_BookTitle.getText().isEmpty()) {
                ...
                if (!check) {
                    take_titleLabel.setText("Книга недоступна!");
    ...
    public void returnBooks() {
        ...
        try {
            ...
            if (return_imageView.getImage() == null) {
                ...
                alert.setTitle("Сообщение администратора");
                alert.setHeaderText(null);
                alert.setContentText("Пожалуйста, выберите книгу, которую хотите вернуть");
                alert.showAndWait();
                ...
                alert.setTitle("Сообщение администратора");
                alert.setHeaderText(null);
                alert.setContentText("Успешно вернулся!");
                alert.showAndWait();
    ...
    public void unsaveBooks() {
        ...
        try {
            ...
            if (save_imageView.getImage() == null) {
                ...
                alert.setTitle("Сообщение администратора");
                alert.setHeaderText(null);
                alert.setContentText("Пожалуйста, выберите книгу, которую хотите отменить.");
                alert.showAndWait();
